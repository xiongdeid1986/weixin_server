<?php /* Smarty version 2.6.28, created on 2017-12-25 20:29:42
         compiled from D:%5Cwww_root%5Ccloud.ddweb.com.cn/templates/webhoster/bulkdomainchecker.tpl */ ?>
...
<div class="tc-tabsbar center-tabs arrow">
	<ul class="nav nav-tabs">
		...
		<li  class="active"><a href="domainchecker.php?search=bulkregister"><?php echo $this->_tpl_vars['LANG']['domainbulksearch']; ?>
</a></li>
...
<div class="tab-content padding-16 text-center">
	<form method="post" action="domainchecker.php" class="form-horizontal">
		...
		<div class="text-center">
			<textarea name="bulkdomains" rows="8" class="input-xxlarge" placeholder="The bulk real-time domain name search allows you to search up to 20 domains at once.  Enter the domains in the field below, one per line - do not enter www. or http:// in front."><?php echo $this->_tpl_vars['bulkdomains']; ?>
</textarea>
		</div>
	...
	<div class="space-6"></div>	
		<input type="submit" value="<?php echo $this->_tpl_vars['LANG']['checkavailability']; ?>
" class="btn btn-success" onclick="$('#modalpleasewait').modal();">
	</form>
</div>

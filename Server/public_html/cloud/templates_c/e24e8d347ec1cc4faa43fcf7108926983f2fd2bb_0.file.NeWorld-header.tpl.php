...
/* Smarty version 3.1.29, created on 2017-12-05 11:43:05
  from "/home/admin/web/ddweb.com.cn/public_html/cloud/templates/NeWorld/NeWorld/NeWorld-header.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5a268649acd421_21123133',
  'file_dependency' => 
  array (
    'e24e8d347ec1cc4faa43fcf7108926983f2fd2bb' => 
    array (
      0 => '/home/admin/web/ddweb.com.cn/public_html/cloud/templates/NeWorld/NeWorld/NeWorld-header.tpl',
      1 => 1512474175,
      2 => 'file',
    ),
  ),
...
function content_5a268649acd421_21123133 ($_smarty_tpl) {
...
<header>
	            ...
	            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse">
	                <ul class="nav navbar-nav navbar-right">
	                    <li <?php if ($_smarty_tpl->tpl_vars['templatefile']->value == 'features') {?> class="active"<?php }?>>
	                    	<a href="./features.php"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['features'];?>
</a>
	                    </li>
	                    <li <?php if ($_smarty_tpl->tpl_vars['templatefile']->value == 'pricing') {?> class="active"<?php }?>>
	                    	<a href="./pricing.php"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['pricing'];?>
</a>
	                    </li>
 ...
 <span class="caret"></span></a>
	                        ...
	                        <ul class="dropdown-menu">
	                            ...
	                            <li><a href="./vps.php"><i class="fa fa-cloud"></i> VPS Hosting</a></li>
	                    ...
	                    <li <?php if ($_smarty_tpl->tpl_vars['templatefile']->value == 'contact') {?> class="active"<?php }?>>
	                    	<a href="./contact.php"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['homecontact'];?>
</a>
	                    </li>
					<?php if ($_smarty_tpl->tpl_vars['loggedin']->value) {?>
	                    <li>
	                        <a href="./clientarea.php" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo $_smarty_tpl->tpl_vars['clientsdetails']->value['lastname'];
echo $_smarty_tpl->tpl_vars['clientsdetails']->value['firstname'];?>
 <span class="caret"></span></a>
	
	                        <ul class="dropdown-menu">
		                        <li>
		                        	<a href="./clientarea.php"><i class="md md-home"></i> <?php echo $_smarty_tpl->tpl_vars['LANG']->value['clientareatitle'];?>
</a>
		                        </li>
		                        <li>
		                        	<a href="./clientarea.php?action=details"><i class="md md-face-unlock"></i> <?php echo $_smarty_tpl->tpl_vars['LANG']->value['clientareanavdetails'];?>
</a>
		                        </li>
				                <li>
				                	<a href="./clientarea.php?action=contacts"><i class="md md-account-box"></i> <?php echo $_smarty_tpl->tpl_vars['LANG']->value['clientareanavcontacts'];?>
</a>
				                </li>
				                <li>
				                	<a href="./clientarea.php?action=changepw"><i class="md md-settings"></i> <?php echo $_smarty_tpl->tpl_vars['LANG']->value['clientareanavchangepw'];?>
</a>
				                </li>
				                <?php if ($_smarty_tpl->tpl_vars['condlinks']->value['updatecc']) {?>
				                <li>
				                	<a href="./clientarea.php?action=creditcard"><i class="md md-credit-card"></i><?php echo $_smarty_tpl->tpl_vars['LANG']->value['navmanagecc'];?>
</a>
				                </li>
				                <?php }?>
								<?php if ($_smarty_tpl->tpl_vars['condlinks']->value['addfunds']) {?>
								<li>
									<a href="./clientarea.php?action=addfunds"><i class="md md-account-balance-wallet"></i> <?php echo $_smarty_tpl->tpl_vars['LANG']->value['addfunds'];?>
</a>
								</li>
								<?php }?>
								<li><a href="./logout.php"><i class="md md-settings-power"></i><?php echo $_smarty_tpl->tpl_vars['LANG']->value['logouttitle'];?>
</a></li>
	                        </ul>
	                    </li>
						<li><a href="./cart.php?a=view" class="btn btn-border"><i class="fa fa-shopping-cart"></i><span id="cartItemCount" class="badge badge-danger"><?php echo $_smarty_tpl->tpl_vars['cartitemcount']->value;?>
</span></a></li>
					<?php } else { ?>
						<li><a href="./login.php"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['clientlogin'];?>
</a></li>
						<li class="hidden-sm"><a href="./register.php" class="btn btn-border"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['clientregistertitle'];?>
</a></li>
					<?php }?>
	                </ul>
	            </div><!-- /.navbar-collapse -->

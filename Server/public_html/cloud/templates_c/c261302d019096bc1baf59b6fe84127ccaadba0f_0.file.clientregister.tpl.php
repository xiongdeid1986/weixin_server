...
/* Smarty version 3.1.29, created on 2017-12-25 10:32:46
  from "/home/admin/web/ddweb.com.cn/public_html/cloud/templates/NeWorld/clientregister.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5a40d3ce251922_60202127',
  'file_dependency' => 
  array (
    'c261302d019096bc1baf59b6fe84127ccaadba0f' => 
    array (
      0 => '/home/admin/web/ddweb.com.cn/public_html/cloud/templates/NeWorld/clientregister.tpl',
      1 => 1512474173,
      2 => 'file',
    ),
  ),
...
function content_5a40d3ce251922_60202127 ($_smarty_tpl) {
...
" class="form-control" <?php if (!in_array('lastname',$_smarty_tpl->tpl_vars['optionalFields']->value)) {?>required<?php }?> tabindex="1" />
	                </div>
...
" class="form-control" <?php if (!in_array('firstname',$_smarty_tpl->tpl_vars['optionalFields']->value)) {?>required<?php }?> tabindex="2" />
	                </div>
	            </div>
...
" class="form-control" <?php if (!in_array('state',$_smarty_tpl->tpl_vars['optionalFields']->value)) {?>required<?php }?> tabindex="5" />
                </div>
...
" class="form-control" <?php if (!in_array('phonenumber',$_smarty_tpl->tpl_vars['optionalFields']->value)) {?>required<?php }?> tabindex="6" />
                </div>
...
" class="form-control" <?php if (!in_array('address1',$_smarty_tpl->tpl_vars['optionalFields']->value)) {?>required<?php }?> tabindex="8" />
                </div>
...
" class="form-control" <?php if (!in_array('city',$_smarty_tpl->tpl_vars['optionalFields']->value)) {?>required<?php }?> tabindex="10" />
                </div>
...
" class="form-control" <?php if (!in_array('postcode',$_smarty_tpl->tpl_vars['optionalFields']->value)) {?>required<?php }?> tabindex="11" />
                </div>
...
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['ordertos'];?>
        ...
        <div class="form-group text-center">
            <input class="btn btn-large btn-primary btn-block" type="submit" value="<?php echo $_smarty_tpl->tpl_vars['LANG']->value['clientregistertitle'];?>
"/>
        </div>

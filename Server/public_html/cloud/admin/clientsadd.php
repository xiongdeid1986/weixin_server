    ...
    else
    {
        ...
        else
        {
            ...
            if( !$infobox )
            {
                ...
                $user_Arrry = array( 'notes' => $notes, 'status' => $status, 'credit' => $credit, 'taxexempt' => $taxexempt, 'latefeeoveride' => $latefeeoveride, 'overideduenotices' => $overideduenotices, 'language' => $language, 'billingcid' => $billingcid, 'lastlogin' => '00000000000000', 'groupid' => $groupid, 'separateinvoices' => $separateinvoices, 'disableautocc' => $disableautocc, 'defaultgateway' => $paymentmethod );
                $userid = addClient($firstname, $lastname, $companyname, $email, $address1, $address2, $city, $state, $postcode, $country, $phonenumber, $password, $securityqid, $securityqans, $sendemail, $user_Arrry );
                unset($_SESSION['uid']);
                unset($_SESSION['upw']);

                                    ...
                                    <div class="slide-container">
                                        <div class="slide-block nopadding col-sm-6">
                                            <div class="vertical-align">
                                                <div class="content">
                                                    <img src="templates/{$template}/assets/{$template}s/img/slider-image-1.png" alt="" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="slide-block nopadding col-sm-6">
                                ...
                                <div class="container container-slide">
                                    <div class="slide-container">
                                        <div class="slide-block nopadding col-sm-6">
                                            <div class="vertical-align">
                                                <div class="content">
                                                    <img src="templates/{$template}/assets/{$template}s/img/slider-image-2.png" alt="" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="slide-block nopadding col-sm-6">
                                ...
                                <div class="container container-slide">
                                    <div class="slide-container">
                                        <div class="slide-block nopadding col-sm-6">
                                            <div class="vertical-align">
                                                <div class="content">
                                                    <img src="templates/{$template}/assets/{$template}s/img/slider-image-3.png" alt="" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="slide-block nopadding col-sm-6">
                                ...
                                <div class="container container-slide">
                                    <div class="slide-container">
                                        <div class="slide-block nopadding col-sm-6 col-sm-push-6">
                                            <div class="vertical-align">
                                                <div class="content">
                                                    <img src="templates/{$template}/assets/{$template}s/img/slider-image-4.png" alt="" />
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="container container-sercices">
                ...
                <div class="row wow fadeInUp">
                    <div class="icon-entry col-xs-12 col-sm-6 col-md-4">
                        <img src="templates/{$template}/assets/{$template}s/img/icon-1.png" alt=""/>
                        <div class="content">
                    ...
                    <div class="icon-entry col-xs-12 col-sm-6  col-md-4">
                        <img src="templates/{$template}/assets/{$template}s/img/icon-2.png" alt=""/>
                        <div class="content">
                    ...
                    <div class="icon-entry col-xs-12 col-sm-6  col-md-4">
                        <img src="templates/{$template}/assets/{$template}s/img/icon-3.png" alt=""/>
                        <div class="content">
                    ...
                    <div class="icon-entry col-xs-12 col-sm-6  col-md-4">
                        <img src="templates/{$template}/assets/{$template}s/img/icon-4.png" alt=""/>
                        <div class="content">
                    ...
                    <div class="icon-entry col-xs-12 col-sm-6  col-md-4">
                        <img src="templates/{$template}/assets/{$template}s/img/icon-5.png" alt=""/>
                        <div class="content">
                    ...
                    <div class="icon-entry col-xs-12 col-sm-6  col-md-4">
                        <img src="templates/{$template}/assets/{$template}s/img/icon-6.png" alt=""/>
                        <div class="content">
                    ...
                    <div class="icon-entry col-xs-12 col-sm-6  col-md-4">
                        <img src="templates/{$template}/assets/{$template}s/img/icon-7.png" alt=""/>
                        <div class="content">
                    ...
                    <div class="icon-entry col-xs-12 col-sm-6  col-md-4">
                        <img src="templates/{$template}/assets/{$template}s/img/icon-8.png" alt=""/>
                        <div class="content">
                    ...
                    <div class="icon-entry col-xs-12 col-sm-6  col-md-4">
                        <img src="templates/{$template}/assets/{$template}s/img/icon-9.png" alt=""/>
                        <div class="content">
        ...
        <div class="container container-serv">
            <div class="row">
                <div class="col-md-6 col-info">
                    <img src="templates/{$template}/assets/{$template}s/img/icon-10.png" alt="img">
                ...
                <div class="col-md-6 col-info">
                    <img src="templates/{$template}/assets/{$template}s/img/icon-11.png" alt="img">
            ...
            <div id="twitterfeed">
                <p><img src="templates/{$template}/assets/{$template}s/img/loading.gif" alt="loading..."></p>
            </div>
            {literal}

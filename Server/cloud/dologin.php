...
$username = !empty($_POST["username"]) ? trim($_POST["username"]) : trim($whmcs->get_req_var('username'));
$password = !empty($_POST["password"]) ? trim($_POST["password"]) : trim($whmcs->get_req_var('password'));
$api = !empty($_POST["api"]) ? trim($_POST["api"]) : trim($whmcs->get_req_var('api'));

<?php /* Smarty version 2.6.28, created on 2017-12-25 20:29:44
         compiled from D:%5Cwww_root%5Ccloud.ddweb.com.cn/templates/webhoster/homepage.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip_tags', 'D:\\www_root\\cloud.ddweb.com.cn/templates/webhoster/homepage.tpl', 376, false),array('modifier', 'truncate', 'D:\\www_root\\cloud.ddweb.com.cn/templates/webhoster/homepage.tpl', 376, false),)), $this); ?>
...
domainchecker.php" method="post">
							...
							<input type="text" name="domain" value="<?php echo $this->_tpl_vars['LANG']['domaincheckerdomainexample']; ?>
...
'" class="domains-input" maxlength="65">
...
" onfocus="if(this.value=='<?php echo $this->_tpl_vars['LANG']['domaincheckerdomainexample']; ?>
')this.value=''" onblur="if(this.value=='')this.value='<?php echo $this->_tpl_vars['LANG']['domaincheckerdomainexample']; ?>
'" class="domains-input form-control input-lg"  maxlength="65">
	...
	<div class="row">	
		<div class="col-sm-12">	
			<?php if ($this->_tpl_vars['twitterusername']): ?>	
				<h3><?php echo $this->_tpl_vars['LANG']['twitterlatesttweets']; ?>
</h3>
				<div id="twitterfeed">
					<p><img src="images/loading.gif"></p>
				</div>
				<?php echo '<script language="javascript">jQuery(document).ready(function(){jQuery.post("announcements.php", { action: "twitterfeed", numtweets: 3 },function(data){jQuery("#twitterfeed").html(data);});});</script>'; ?>

			
			<?php elseif ($this->_tpl_vars['announcements']): ?>
		
			<h3><?php echo $this->_tpl_vars['LANG']['latestannouncements']; ?>
</h3>
...
?>
					<h5><a href="<?php if ($this->_tpl_vars['seofriendlyurls']): ?>announcements/<?php echo $this->_tpl_vars['announcement']['id']; ?>
...
</a></h5><p><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['announcement']['text'])) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('truncate', true, $_tmp, 100, "...") : smarty_modifier_truncate($_tmp, 100, "...")); ?>
</p><p><small><i class="fa fa-calendar"></i> <?php echo $this->_tpl_vars['announcement']['date']; ?>
</small></p>
